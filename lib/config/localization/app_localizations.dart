...
abstract class AppLocalizations {
  ...
  /// No description provided for @textscaleDecrease.
  ///
  /// In en, this message translates to:
  /// **'Decrease text size'**
  String get textscaleDecrease;

  /// No description provided for @textscaleIncrease.
  ///
  /// In en, this message translates to:
  /// **'Increase text size'**
  String get textscaleIncrease;

  /// Shows the current text zoom level.
  ///
  /// In en, this message translates to:
  /// **'Current scale: {value}x'**
